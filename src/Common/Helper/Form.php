...
EOT;
     ...
     *
     */
    public static function form_field_cdn_object_picker($field, $tip = '')
    {
        //  Set var defaults
        $_field_id         = isset($field['id']) ? $field['id'] : null;
        $_field_type       = isset($field['type']) ? $field['type'] : 'text';
...
EOT;
     ...
     *
     */
    public static function form_field_cdn_object_picker_multi($field, $tip = '')
    {
        //  Set var defaults
        $_field_id         = isset($field['id']) ? $field['id'] : null;
        $_field_type       = isset($field['type']) ? $field['type'] : 'text';
...
EOT;
     ...
     *
     */
    public static function form_field_cdn_object_picker_multi_with_label($aConfig, $sTip = '')
    {
        //  Set var defaults
...
EOT;
     ...
     *
     */
    public static function form_field_mm($aField, $sTip = '')
    {
     ...
     *
     */
    public static function form_field_mm_image($aField, $sTip = '')
    {
        return form_field_cdn_object_picker($aField, $sTip);
    }
