	...
	<div class="row">
		<div class="jumbotron <?=BS_COL_LG_10?> <?=BS_COL_LG_OFFSET_1?>">
			...
			<?php
				...
				$_data_available[1]->variable		= 'ranges';
				$_data_available[1]->description	= 'An array of the ranges containing active items, including count.';
			...
			<?php
				...
				if ( ! empty( ${$_data_available[1]->variable}[0]->slug ) ) :
					...
					echo '<ul class="list-unstyled">';
						...
						echo '<li>&rsaquo; ' . anchor( app_setting( 'url', 'shop' ) . 'range/' . ${$_data_available[1]->variable}[0]->slug, 'Single Range page' ) . '</li>';
