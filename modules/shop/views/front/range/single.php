	...
	<div class="row">
		<div class="jumbotron <?=BS_COL_LG_10?> <?=BS_COL_LG_OFFSET_1?>">
			...
			<?php
				...
				$_data_available[0]->variable		= 'range';
				$_data_available[0]->description	= 'The range object';

				$_data_available[1]					= new stdClass();
				$_data_available[1]->variable		= 'products';
				$_data_available[1]->description	= 'An array of products which feature this range.';
