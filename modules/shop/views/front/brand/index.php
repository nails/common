	...
	<div class="row">
		<div class="jumbotron <?=BS_COL_LG_10?> <?=BS_COL_LG_OFFSET_1?>">
			...
			<?php
				...
				$_data_available[0]->variable		= 'brands';
				$_data_available[0]->description	= 'An array of the brands containing active items, including count.';
			...
			<?php
				...
				if ( ! empty( ${$_data_available[0]->variable}[0]->slug ) ) :
					...
					echo '<ul class="list-unstyled">';
						...
						echo '<li>&rsaquo; ' . anchor( shop_setting( 'shop_url' ) . 'brand/' . ${$_data_available[0]->variable}[0]->slug, 'Single Brand page' ) . '</li>';
