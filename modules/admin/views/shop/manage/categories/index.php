<div class="group-shop manage categories overview">
	...
	<ul class="tabs disabled">
		<li class="tab active">
			<?=anchor( 'admin/shop/manage/categories' . $is_fancybox, 'Overview' )?>
		</li>
		<li class="tab">
			<?=anchor( 'admin/shop/manage/categories/create' . $is_fancybox, 'Create Category' )?>
		</li>
	</ul>
							...
							echo '<tr>';
								echo '<td class="label indentosaurus indent-' . $category->depth . '">';
									...
									echo '<div class="indentor-content">';
										...
										echo $category->description ? '<small>' . strip_tags( $category->description ) . '</small>' : '';
								...
								echo '<td class="actions">';
									...
									if ( user_has_permission( 'admin.shop.categories_edit' ) ) :
										...
										echo anchor( 'admin/shop/manage/categories/edit/' . $category->id . $is_fancybox, lang( 'action_edit' ), 'class="awesome small"' );

									endif;

									if ( user_has_permission( 'admin.shop.categories_delete' ) ) :

										echo anchor( 'admin/shop/manage/categories/delete/' . $category->id . $is_fancybox, lang( 'action_delete' ), 'class="awesome small red confirm" data-title="Are you sure?" data-body="This action cannot be undone."' );
...
<?php
	...
	$this->load->view( 'admin/shop/manage/categories/_footer' );