...
<h1>Manage School Grades &rsaquo; Edit Level</h1>

<p>
	You can edit this level using the form below. Please note that any modification of this level will be shown across the website
...
<div class="" style="margin-left:10px;margin-right:10px;width:300px;">
	...
	<div class="box">
		...
		<h2>Edit Level</h2>
			...
			<?=form_open_multipart( 'admin/lists/school_level_edit/' . $i->id . '/' )?>
			...
			?>
				...
				<table class="blank" style="width:auto;">
					...
					<tr>
						...
						<td>
							<input type="text" name="name" value="<?=$i->level?>">
						</td>
