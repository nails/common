...
$(function () 
{
	...
	$( 'input[name=name]' ).keyup( function() {
		...
		$( '#professional_qualification-list' ).find( '.searchable' ).each( function() {
		...
		//	How many results
		$( '#professional_qualification-list .searchable' ).each( function() {
...
<h1>Manage Professional Qualifications</h1>

<p>
	Qualifications are used and specified in user professional qualifications.  You cannot delete any
...
<div class="left" style="margin-left:10px;margin-right:10px;width:400px;">
	...
	<div class="box">
		...
		<h2>Add New Qualification</h2>
			...
			<?=form_open_multipart( 'admin/lists/professional_qualification' )?>
	...
	<?php
		...
		foreach ( $professional_qualifications->result() AS $i ) :
...
<div class="left box" style="margin-left:10px;margin-right:10px;width:auto;">
	...
	<table id="professional_qualification-list" style="padding:0 10px 10px;">
			
		<tbody>
		
			<?php $temp = array(); ?>
			<?php foreach ( $professional_qualifications->result() AS $i ) : ?>
			...
			<tr>
				...
				<td width="88">
					...
					<?=anchor( 'admin/lists/professional_qualification_edit/' . $i->id, 'Edit', 'class="a-button a-button-small"' )?>
					<?php if ( $i->u_count == 0 ) : ?>
						<?=anchor( 'admin/lists/professional_qualification_delete/' . $i->id, 'Delete', 'class="a-button a-button-small confirm-delete"' )?>
					<?php endif; ?>
