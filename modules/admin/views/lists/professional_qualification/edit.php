<?php
	...
	$i = $professional_qualification->row();
...
<h1>Manage Professional Qualifications &rsaquo; Edit Qualification</h1>
...
<div class="" style="margin-left:10px;margin-right:10px;width:300px;">
	...
	<div class="box">
		...
		<h2>Edit Qualification</h2>
			...
			<?=form_open_multipart( 'admin/lists/professional_qualification_edit/' . $i->id . '/' )?>
