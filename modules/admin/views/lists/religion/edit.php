...
<h1>Manage Religions &rsaquo; Edit Religion</h1>

<p>
	You can edit this religion using the form below. Please note that any modification of this religion will be shown across the website
...
<div class="" style="margin-left:10px;margin-right:10px;width:300px;">
	...
	<div class="box">
		...
		<h2>Edit Religion</h2>
			...
			<?=form_open_multipart( 'admin/lists/religion_edit/' . $i->id . '/' )?>
