...
<h1>Manage Courses &rsaquo; Edit Course</h1>

<p>
	You can edit this course using the form below. Please note that any modification of this course will be shown across the website
...
<div class="" style="margin-left:10px;margin-right:10px;width:300px;">
	...
	<div class="box">
		...
		<h2>Edit Course</h2>
			...
			<?=form_open_multipart( 'admin/lists/qualification_course_edit/' . $i->id . '/' )?>
