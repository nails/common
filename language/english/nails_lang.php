...
$lang['fv_date_today_field']            = 'The %s field must be today\'s date.';
...
$lang['fv_valid_time_field']            = 'The %s field is not a valid time.';
$lang['fv_time_future']                 = 'This field must be in the future.';
$lang['fv_time_future_field']           = 'The %s field must be in the future.';
$lang['fv_time_past']                   = 'This field must be in the past.';
$lang['fv_time_past_field']             = 'The %s field must be in the past.';
$lang['fv_time_before']                 = 'This must be before the %2$s field.';
$lang['fv_time_before_field']           = 'The %s field must be before the %s field.';
$lang['fv_time_after']                  = 'This must be after the %2$s field.';
$lang['fv_time_after_field']            = 'The %s field must be before the %s field.';
