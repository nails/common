...
$lang['fv_valid_email_field']           = 'The {field} field must be a valid email.';
...
$lang['fv_date_after_field']            = 'The {field} field must be after the {param} field.';
...
$lang['fv_datetime_after_field']        = 'The {field} field must be after the {param} field.';
...
$lang['fv_time_after_field']            = 'The {field} field must be after the {param} field.';
...
$lang['fv_is_natural_no_zero_field']    = 'The {field} field must be a natural number greater than zero (1, 2, 3, etc).';
...
$lang['fv_integer_field']               = 'The {field} field must be an integer';
...
$lang['fv_max_words']                   = 'This field is too long, maximum {param} words.';
$lang['fv_max_words_field']             = 'The {field} field is too long, maximum {param} words.';
$lang['fv_isset']                       = 'This field must have a value.';
$lang['fv_isset_field']                 = 'The {field} field must have a value.';
$lang['fv_alpha']                       = 'This field may only contain alphabetical characters.';
$lang['fv_alpha_field']                 = 'The {field} field may only contain alphabetical characters.';
$lang['fv_alpha_numeric']               = 'This field may only contain alpha-numeric characters.';
$lang['fv_alpha_numeric_field']         = 'The {field} field may only contain alpha-numeric characters.';
$lang['fv_alpha_numeric_spaces']        = 'This field may only contain alpha-numeric characters and spaces.';
$lang['fv_alpha_numeric_spaces_field']  = 'The {field} field may only contain alpha-numeric characters and spaces.';
$lang['fv_decimal']                     = 'This field must contain a decimal number.';
$lang['fv_decimal_field']               = 'The {field} field must contain a decimal number.';
$lang['fv_differs']                     = 'This field must differ from the {param} field.';
$lang['fv_differs_field']               = 'The {field} field must differ from the {param} field.';
$lang['fv_exact_length']                = 'This field must be exactly {param} characters long.';
$lang['fv_exact_length_field']          = 'The {field} field must be exactly {param} characters long.';
$lang['fv_regex_match']                 = 'This field is not in the correct format.';
$lang['fv_regex_match_field']           = 'The {field} field is not in the correct format.';
$lang['fv_valid_url']                   = 'This field must be a valid URL.';
$lang['fv_valid_url_field']             = 'The {field} field must be a valid URL.';
$lang['fv_valid_ip']                    = 'This field must be a valid IP address.';
$lang['fv_valid_ip_field']              = 'The {field} field must be a valid IP address.';
$lang['fv_valid_mac']                   = 'This field must be a valid MAC address.';
$lang['fv_valid_mac_field']             = 'The {field} field must be a valid MAC address.';
$lang['fv_valid_base64']                = 'This field must be a valid Base64 string.';
$lang['fv_valid_base64_field']          = 'The {field} field must be a valid Base64 string.';
$lang['fv_is_array']                    = 'This field must be an array.';
$lang['fv_is_array_field']              = 'The {field} field must be an array.';
$lang['fv_item_count']                  = 'This field contains an invalid number of items.';
$lang['fv_item_count_field']            = 'The {field} field contains an invalid number of items.';
$lang['fv_closure']                     = 'Field failed validation.';
$lang['fv_closure_field']               = 'The {field} field failed validation.';
